...
class ESUserServiceTest {
    ...
    void testDeleteByESUsers() {
        ...
        final List<ESUserPO> esUserPOS = Arrays.asList(new ESUserPO(0, 0, "elastic", "pwd", "verifyCode", "memo", 0, 0,
    ...
    void testGetDefaultESUserByProject() {
        // Setup
        final ESUser expectedResult = new ESUser(0, "name", 0, "username", "pwd", "verifyCode",
